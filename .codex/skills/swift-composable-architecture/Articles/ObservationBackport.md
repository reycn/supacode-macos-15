...
If you want to derive bindings from the store (see [Working with SwiftUI bindings](Bindings.md) for more information), then you
...
See [Incrementally migrating](MigrationGuides/MigratingTo1.7.md#Incrementally-migrating) for more information about this.
