...
> tools of version 1.11. See [Migration guides](../Articles/MigrationGuides.md) for more information.

## Custom file storage coding

Version 1.10 of the Composable Architecture introduced a powerful tool for 
[sharing state]([Sharing state](../Articles/SharingState.md)) amongst your features, and included several built-in persistence
