...
tools of version 1.6. See [Migrating to 1.4](../Articles/MigrationGuides/MigratingTo1.4.md), [Migrating to 1.5](../Articles/MigrationGuides/MigratingTo1.5.md), and [Migrating to 1.6](../Articles/MigrationGuides/MigratingTo1.6.md) for
more information.
...
[Observation backport](../Articles/ObservationBackport.md) article for more information on how to use the new observation tools if
...
## Using There are two ways to update existing code to use the new `ObservableState()` macro depending on
...
## Replacing @PresentationState with It is a well-known limitation of Swift macros that they cannot be used with property wrappers.
...
[Backwards compatible availability](../Articles/TreeBasedNavigation.md#Backwards-compatible-availability) for more information.
...
[Binding State](BindingState.md), `BindableAction`, `BindingAction`, `BindingViewState` and 
...
your feature's state with `ObservableState()` and removing all instances of [Binding State](BindingState.md):
