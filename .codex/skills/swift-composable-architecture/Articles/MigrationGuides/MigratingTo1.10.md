...
> tools of version 1.9. See [Migration guides](../Articles/MigrationGuides.md) for more information.
...
[Sharing state](../Articles/SharingState.md) article for more information on how to use these new tools. 
...
That is the basics of sharing data. Be sure to see the dedicated [Sharing state](../Articles/SharingState.md) article
