...
Further, using "non-exhaustive testing" (see [Non exhaustive testing](TestingTCA.md#Non-exhaustive-testing)) can be very 
...
concepts outlined in [Enum state](TreeBasedNavigation.md#Enum-state) in which you model multiple destinations
