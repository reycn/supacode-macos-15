...
`IdentifiedAction` in your feature's actions (see [Identified actions](../Articles/MigrationGuides/MigratingTo1.4.md#Identified-actions) for more
...
See the dedicated article [Store scoping](../Articles/Performance.md#Store-scoping) for more information.
