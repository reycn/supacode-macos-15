...
> tools of version 1.10. See [Migration guides](../Articles/MigrationGuides.md) for more information.
...
[sharing state]([Sharing state](../Articles/SharingState.md)) amongst your features. And you can mutate a piece of shared
...
In [version 1.11]([Migrating to 1.11](../Articles/MigrationGuides/MigratingTo1.11.md)) of the library we deprecated mutating shared state from
...
the [migration guide]([Migrating to 1.11](../Articles/MigrationGuides/MigratingTo1.11.md)) for more info).
