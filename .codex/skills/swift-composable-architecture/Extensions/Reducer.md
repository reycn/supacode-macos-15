...
> [Dependencies](../Articles/DependencyManagement.md) and [Testing](../Articles/TestingTCA.md) articles for more information.
...
navigated to. This is explained in great detail in the [Tree-based navigation](../Articles/TreeBasedNavigation.md) and
[Stack-based navigation](../Articles/StackBasedNavigation.md) articles.
...
[Stack-based navigation](../Articles/StackBasedNavigation.md), and in that case you can leave off the trailing closure of the
...
[Destination and path reducers](Reducer.md#Destination-and-path-reducers) above) you cannot construct the cases of the state 
enum inside `#Preview`:
...
- [Deprecations](Deprecations/ReducerDeprecations.md)
