...
navigation]([Tree-based navigation](../Articles/TreeBasedNavigation.md)) for more information on these tools):
...
domain like so (see the docs on [stack-based]([Stack-based navigation](../Articles/StackBasedNavigation.md)) for more information
on these tools):
