...
> [Meet Composable Architecture](MeetComposableArchitecture.md).
...
feature, and it will be annotated with the [`@Reducer`]([Reducer()](Reducer().md)) macro:
...
> **Note:** For more in-depth information on testing, see the dedicated [Testing](TestingTCA.md) 
article.
...
[Dependencies](DependencyManagement.md) article. 
...
_a lot_ more things to be explored. Be sure to check out the [Meet Composable Architecture](MeetComposableArchitecture.md) 
tutorial, as well as dedicated articles on [Dependencies](DependencyManagement.md), [Testing](TestingTCA.md), 
[Navigation](Navigation.md), [Performance](Performance.md), and more. Also, the [Examples][examples] directory has 
