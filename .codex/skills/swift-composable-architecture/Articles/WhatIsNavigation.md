...
That is the basics of tree-based navigation. Read the dedicated [Tree-based navigation](TreeBasedNavigation.md) article
...
[Stack-based navigation](StackBasedNavigation.md) article for information on how to use the tools that come with the 
...
#### Pros of tree-based navigation
  ...
  * Tree-based navigation unifies all forms of navigation into a single, concise style of API, 
    ...
    [API Unification](TreeBasedNavigation.md#API-Unification) for more information.
...
the dedicated articles [Tree-based navigation](TreeBasedNavigation.md) and [Stack-based navigation](StackBasedNavigation.md) to learn about the 
