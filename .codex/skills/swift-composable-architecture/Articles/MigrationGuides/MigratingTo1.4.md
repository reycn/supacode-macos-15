...
See the documentation of [Gotchas](../Extensions/Reducer.md#Gotchas) for more gotchas on using the `@Reducer` macro. 
...
`IdentifiedAction` (more information below in [Identified actions](../Articles/MigrationGuides/MigratingTo1.4.md#Identified-actions)), then
